...
/*   Updated: 2022/05/16 15:35:13 by khirsig          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const static std::string eloName[19] = { "Sapphire 1", "Sapphire 2", "Sapphire 3", "Bronze 1", "Bronze 2", "Bronze 3",
										"Silver 1", "Silver 2", "Silver 3", "Gold 1", "Gold 2", "Gold 3",
										"Platin 1", "Platin 2", "Platin 3", "Diamond 1", "Diamond 2",
										"Diamond 3", "Immortal" };
const static raylib::Color eloColor[19] = { BLUE, BLUE, BLUE, BROWN, BROWN, BROWN, LIGHTGRAY, LIGHTGRAY, LIGHTGRAY,
